      ...
      <div className="grid grid-cols-1 md:grid-cols-12 ">
          ...
          >
            ...
            <p className="text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                href="https://drive.usercontent.google.com/download?id=1pXNVU6Z0owCCPSu0dlWav6qP-F7Qs-Yy&export=download&authuser=0&confirm=t&uuid=3fe2532e-9535-4bd3-9951-cf1442c9ad36&at=APZUnTVLM2rm2YzRHBM4mce8zFWC:1702172034894"
